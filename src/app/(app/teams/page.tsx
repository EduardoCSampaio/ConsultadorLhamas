...
export default function MyTeamPage() {
    ...
    const { data: allTeamMembers, isLoading: isTeamMembersLoading } = useCollection<UserProfile>(teamMembersQuery);

    const teamMembers = useMemo(() => {
        return allTeamMembers?.filter(member => member.uid !== manager?.uid) || [];
    }, [allTeamMembers, manager?.uid]);
    ...
    const finalLoadingState = isManagerAuthLoading || isManagerProfileLoading || isTeamMembersLoading;
